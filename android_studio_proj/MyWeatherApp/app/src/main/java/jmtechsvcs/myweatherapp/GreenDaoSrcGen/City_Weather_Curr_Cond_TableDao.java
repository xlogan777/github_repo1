...
/** 
 * DAO for table CITY__WEATHER__CURR__COND__TABLE.
*/
public class City_Weather_Curr_Cond_TableDao extends AbstractDao<City_Weather_Curr_Cond_Table, Long> {

    public static final String TABLENAME = "CITY__WEATHER__CURR__COND__TABLE";

    /**
     * Properties of entity City_Weather_Curr_Cond_Table.<br/>
    ...
    */
    ...
    public City_Weather_Curr_Cond_TableDao(DaoConfig config) {
        super(config);
    }
    
    public City_Weather_Curr_Cond_TableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CITY__WEATHER__CURR__COND__TABLE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'CITY__WEATHER__CURR__COND__TABLE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, City_Weather_Curr_Cond_Table entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public City_Weather_Curr_Cond_Table readEntity(Cursor cursor, int offset) {
        City_Weather_Curr_Cond_Table entity = new City_Weather_Curr_Cond_Table( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, City_Weather_Curr_Cond_Table entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(City_Weather_Curr_Cond_Table entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(City_Weather_Curr_Cond_Table entity) {
        if(entity != null) {
