...
package jmtechsvcs.myweatherapp.snstest;
            ...
            if(intent!=null){
                ...
                if(extras!=null){
                    for(String key: extras.keySet()){
                        ...
                        String tmp = "_wasNILL_";
                        Log.d("SAMPLE","KEY VAL = "+key);
                        if(extras.getString(key) != null && extras.getString(key).length() > 0)
                        {
                            tmp = extras.getString(key);
                        }
