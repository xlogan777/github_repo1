...
import com.util.mydao_data_layer.dataTypes.CntLeadMediaTypeIface;
...
//public class ContentItemLeadMediaTable implements EntityItemIface, CntLeadMediaTypeIface{
// KEEP INCLUDES END
/**
...
public class ContentItemLeadMediaTable implements EntityItemIface, CntLeadMediaTypeIface{
    ...
    public String getDebugString()
    {
    	...
    	sb.append("LeadMediaContentType = ");
    	sb.append(LeadMediaContentType);
    	sb.append(" ");
    	
    	sb.append("LeadMediaExtID = ");
    	sb.append(LeadMediaExtID);
    	sb.append(" ");
    	
    	sb.append("LeadEmbeddedVideo = ");
    	sb.append(LeadEmbeddedVideo);
    	sb.append(" ");
    	
    	sb.append("LeadMediaThumbnailType = ");
    	sb.append
    	(T_UrlTypeToId.getEnumFromID(LeadMediaThumbnailType).toString());
    	sb.append(" ");
    	
    	if(urlImgFileTable == null)
    		this.getUrlImgFileTable();
    	
    	if(urlImgFileTable != null)
    	{
    		sb.append(urlImgFileTable.getDebugString());
    	}    	    	
    	return sb.toString();
    }	
    // KEEP METHODS END
