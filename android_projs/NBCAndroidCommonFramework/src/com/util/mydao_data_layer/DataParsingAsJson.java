...
//create pojo for cnt lead media table
		...
		cnt_lead_media_table_bean.setLeadMediaThumbnailType
			(DataBaseHelper.T_UrlTypeToId.E_LEAD_MEDIA_THUMBNAIL_URL_TYPE.getUrlTypeID());
		...
		(
		 ...
		 null,
		 metadata_contentId, 
		 DataBaseHelper.T_UrlTypeToId.E_LEAD_MEDIA_THUMBNAIL_URL_TYPE, 
...
//create pojo for cnt media table
		...
		cnt_media_table_bean.setMediaUrlType(DataBaseHelper.T_UrlTypeToId.E_MEDIA_URL_TYPE.getUrlTypeID());		
		...
		(
		 ...
		 null,
		 metadata_contentId, 
		 DataBaseHelper.T_UrlTypeToId.E_MEDIA_URL_TYPE, 
		 cnt_media_table_bean, 
		 this
		);
				
		cnt_media_table_bean.setMediaPhotoThumbnailUrlType(DataBaseHelper.T_UrlTypeToId.E_MEDIA_PHOTO_THUMBNAIL_URL_TYPE.getUrlTypeID());		
		...
		(
		 ...
		 null,
		 metadata_contentId, 
		 DataBaseHelper.T_UrlTypeToId.E_MEDIA_PHOTO_THUMBNAIL_URL_TYPE,
		 cnt_media_table_bean, 
		 this
		);
		...
		cnt_media_table_bean.setMediaThumbnailUrlType(DataBaseHelper.T_UrlTypeToId.E_MEDIA_THUMBNAIL_URL_TYPE.getUrlTypeID());		
		dbIface.peformUrlStringToTableAssociations
		(
		 detailContentFields_thumbnailUrl,
		 img_details,
		 metadata_contentId, 
		 DataBaseHelper.T_UrlTypeToId.E_MEDIA_THUMBNAIL_URL_TYPE, 
		 cnt_media_table_bean, 
		 this
		);
//create pojo for cnt media table		
...
//create pojo for cnt items table
	...
	(String inputString, ParsingInputParams parsingInputParams, SqliteDBAbstractIface dbIface) throws Exception
	{
		...
		//create pojo for related items table
			...
			(DataBaseHelper.T_UrlTypeToId.E_REL_ITEM_MOBILE_THUMBNAIL_URL_TYPE.getUrlTypeID());
			...
			(
			 ...
			 null,
			 relCmsId, 
			 DataBaseHelper.T_UrlTypeToId.E_REL_ITEM_MOBILE_THUMBNAIL_URL_TYPE, 
			 related_items_table_bean, 
			 this
			);
			
			related_items_table_bean.setRelItemStoryThumbnailUrlType
			(DataBaseHelper.T_UrlTypeToId.E_REL_ITEM_STORY_THUMBNAIL_URL_TYPE.getUrlTypeID());
			...
			(
			 ...
			 null,
			 relCmsId, 
			 DataBaseHelper.T_UrlTypeToId.E_REL_ITEM_STORY_THUMBNAIL_URL_TYPE, 
			 related_items_table_bean, 
			 this
			);
