...
//public class ContentItemMediaTable implements EntityItemIface, CntMediaTypeIface{
// KEEP INCLUDES END
/**
...
public class ContentItemMediaTable implements EntityItemIface, CntMediaTypeIface{
	...
	@Override
	public void accept(EntityVisitorIface entityVisitorIface, DataBaseHelper.T_UrlTypeToId typeID, UrlImgFileTable urlImgFileTable) 
	{
...
//        private UrlImgFileTable mediaThumbnailUrlImgType;
    	...
    	sb.append("MediaUrlType = ");
    	sb.append
    	(T_UrlTypeToId.getEnumFromID(MediaUrlType).toString());
    	sb.append(" ");
    	
    	if(mediaUrlImgType == null)
    		this.getMediaUrlImgType();
    	
    	if(mediaUrlImgType != null)
    	{
    		sb.append(mediaUrlImgType.getDebugString());
    	}
    	
    	sb.append("MediaPhotoThumbnailUrlType = ");
    	sb.append
    	(T_UrlTypeToId.getEnumFromID(MediaPhotoThumbnailUrlType).toString());
    	sb.append(" ");
    	
    	if(mediaPhotoThumbnailUrlImgType == null)
    		this.getMediaPhotoThumbnailUrlImgType();
    	
    	if(mediaPhotoThumbnailUrlImgType != null)
    	{
    		sb.append(mediaPhotoThumbnailUrlImgType.getDebugString());
    	}
    	
    	sb.append("MediaThumbnailUrlType = ");
    	sb.append
    	(T_UrlTypeToId.getEnumFromID(MediaThumbnailUrlType).toString());
    	sb.append(" ");
    	
    	if(mediaThumbnailUrlImgType == null)
    		this.getMediaThumbnailUrlImgType();
    	
    	if(mediaThumbnailUrlImgType != null)
    	{
    		sb.append(mediaThumbnailUrlImgType.getDebugString());
    	}
