...
import com.util.mydao_data_layer.dataTypes.RelCntItemTypeIface;
...
public class RelatedItemsTable implements EntityItemIface, RelCntItemTypeIface{
    ...
    public String getDebugString()
	{
    	...
    	sb.append("RelatedItemsRowId = ");
    	sb.append(id);
    	sb.append(" ");
    	
    	sb.append("ParentCmsID = ");
    	sb.append(ParentCmsID);
    	sb.append(" ");
    	...
    	sb.append("RelItemMobileThumbnailUrlType = ");    	
    	sb.append
    	(T_UrlTypeToId.getEnumFromID(RelItemMobileThumbnailUrlType).toString());
    	sb.append(" ");
    	
    	sb.append("RelItemStoryThumbnailUrlType = ");
    	sb.append
    	(T_UrlTypeToId.getEnumFromID(RelItemStoryThumbnailUrlType).toString());
    	sb.append(" ");
    	...
    	if(relItemMobileThumbnailUrlImgType == null)
    		this.getRelItemMobileThumbnailUrlImgType();
    	
    	if(relItemMobileThumbnailUrlImgType != null)
    	{
    		sb.append(relItemMobileThumbnailUrlImgType.getDebugString());
    	}
    	
    	if(relItemStoryThumbnailUrlImgType == null)
    		this.getRelItemStoryThumbnailUrlImgType();
    	
    	if(relItemStoryThumbnailUrlImgType != null)
    	{
    		sb.append(relItemStoryThumbnailUrlImgType.getDebugString());
    	}
